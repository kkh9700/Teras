<div align="center">
  <br />
  <img src="/build/Teras_logo_home.png" alt="TerasStudy" />
  <br />
  <h1>테라스처럼 편한 학교</h1>
  <br />
</div>
...
|                              디렉토리 구조                       |
| :------------------------------------------------------------------------------: |
| 프론트엔드![image](/assets/디렉토리_프론트.jpg) 백엔드![image](/assets/디렉토리_백엔드.jpg) |
...
|                              온라인 수업                                      |
| :---------------------------------------------------------------------------: |
|  <img src="/assets/온라인수업.gif" alt="온라인수업" />                |

|                              스터디룸                                      |
| :---------------------------------------------------------------------------: |
|  <img src="/assets/스터디룸.gif" alt="스터디룸" />                |
...
|                              공지사항(선생님)                  |
| :---------------------------------------------------------------------------: |
|  <img src="/assets/공지사항선생님.gif" alt="공지사항(선생님)" />  |

|                              공지사항(학생)                  |
| :---------------------------------------------------------------------------: |
|  <img src="/assets/공지사항학생.gif" alt="공지사항(학생)" />  |
...
|                              과제(선생님)                     |
| :---------------------------------------------------------------------------: |
|  <img src="/assets/과제선생님.gif" alt="과제(선생님)" />  |

|                              과제(학생)                      |
| :---------------------------------------------------------------------------: |
|  <img src="/assets/과제학생.gif" alt="과제(학생)" />  |
...
|                              기타등등                    |
| :---------------------------------------------------------------------------: |
|  <img src="/assets/기타등등.gif" alt="기타등등" />  |
...
|                            Notion                      |
| :---------------------------------------------------------------------------: |
|  <img src="/assets/기능명세서.jpg" /><img src="/assets/마일스톤.jpg" />  |
